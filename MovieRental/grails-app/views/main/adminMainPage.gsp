...
<div class="row-fluid">
	...
	<div class="span2">
	<g:if test="${requests}">
		<strong><font color="black">Customer Request:</font></strong>
		<table width="1000">
		...
		<g:each in="${requests}" var="request">
			<tr>
				<td><font color="black"><center>${request.id}</center></font></td>
				<td><font color="black"><center>${request.first_name}</center></font></td>
				<td><font color="black"><center>${request.last_name}</center></font></td>
				<td><font color="black"><center>${request.address}</center></font></td>
				<td><font color="black"><center>${request.contact_number}</center></font></td>
				<td><font color="black"><center>${request.email}</center></font></td>
				<td>
