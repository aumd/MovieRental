...
<body>
	...
	<div align="center">
		<g:form controller="main" action="manageInventory2" class="form-search">
			<font color="black">Search for title,director,genre,medium, actor or actress:</font> <br/><input type="text" placeholder="Search" name="parameter" value="${parameter}" class="input-medium search-query input-xlarge icon-search">
